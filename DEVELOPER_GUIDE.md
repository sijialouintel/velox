...
# Example:
# docker build --build-arg http_proxy="http://child-prc.intel.com:913" --build-arg https_proxy="http://child-prc.intel.com:913" -t omnisci-dev:1.0 .
...
You can use the `velox/scripts/settings.xml` file to replace what is generated by Maven.

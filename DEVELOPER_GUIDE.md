...
1. [How to build](#1)  
    ...
    * 1.2. [Build](#1.2)   
        ...
        * 1.2.4. [Build Velox + Omnisci with docker image](#1.2.4)     
        * 1.2.5. [Build Velox + Omnisci with Dockerfile](#1.2.5)     
    * 1.3. [Build JNI](#1.3)   
    * 1.4. [Build Java](#1.4) 
...
#### <a name="1.2.4"></a>1.2.4. Build Velox + Omnisci with docker image
Repo:
...
// Presto_cpp branch: Modular_SQL (hasn't been used )
Velox branch: Modular_SQL

Steps :

```
# Download pre-built docker image from location:
# root@sr413:/root/ubuntu_20_04_cider_12_23_21.tar
# name convention: [Linux_dist][Linuxdocker _version]cider[MM]_[DD]_[YY].tar  

# Import the image  
docker load --input <dockeriamges.tar> 
docker image tag <image_id> omnisci-dev:1.0 
...
# Examples: 
# 1. docker run -d --name omnisci-dev --privileged=true -v /home/admin/projects/omniscidb:/omniscidb -v /home/admin/.m2/repository:/root/.m2/repository omnisci-dev:1.0 /usr/sbin/init
...
# TODO: add this part in Dockerfile
...
#### <a name="1.2.5"></a>1.2.5. Build Velox + Omnisci with Dockerfile
TODO:
